        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Gloxus is the pioneer to a different approach in hiring in Japan,
              we aim to provide an engaging and personalized hiring experience to 
              add value to the hiring scene in Japan where less and less candidates are available.
            </p>
